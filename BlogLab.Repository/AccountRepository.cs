...
namespace BlogLab.Repository
{
    ...
    {
        private readonly IConfiguration _config; // IConfiguration allows us to access "appsettings.json"
        ...
        public async Task<IdentityResult> CreateAsync(ApplicationUserIdentity user, CancellationToken cancellationToken)
        {
            ...
            using (SqlConnection connection = new SqlConnection(_config.GetConnectionString("DefaultConnection")))
            {
                ...
                await connection.ExecuteAsync("dbo.Account_Insert", 
        ...
        public async Task<ApplicationUserIdentity> GetByUsernameAsync(string normalizedUsername, CancellationToken cancellationToken)
        {
            ...
            ApplicationUserIdentity applicationUser = new ApplicationUserIdentity();
